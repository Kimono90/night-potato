...
export const testRecipe1: IRecipe = {
  ...
  ingredients: [
    { id: 1, product: 'Chickpeas', amount: 500, measurement: 'gram' },
    { id: 2, product: 'Coconut milk', amount: 250, measurement: 'ml' },
    {
      id: 3,
...
export const testRecipe2: IRecipe = {
  ...
  ingredients: [
    { id: 1, product: 'Chocolate', amount: 300, measurement: 'gram' },
    { id: 2, product: 'Eggs', amount: 2, measurement: 'pcs' },
    { id: 3, product: 'Sugar', amount: 250, measurement: 'gram' },
    { id: 4, product: 'Butter', amount: 200, measurement: 'gram' },
  ],
  equipment: [
    { id: 1, name: 'Mixer' },
    { id: 2, name: 'Sharp knife' },
...
export const brazilianPudding: IRecipe = {
  ...
  ingredients: [
    { id: 1, product: 'Can of condensed milk (400g)', amount: 1, measurement: '' },
    { id: 2, product: 'Eggs', amount: 2, measurement: '' },
    { id: 3, product: 'Sugar', amount: 100, measurement: 'gram' },
    { id: 4, product: 'Milk', amount: 400, measurement: 'ml' },
  ],
  equipment: [
